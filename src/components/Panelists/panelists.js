    ...
    render() {
        return(
            <React.Fragment>
                ...
                <div className="grid">
                    <div class="item">
                        <img src={BriannaPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                        <h1>Brianna Wong</h1>
                    ...
                    <div class="item">
                        <img src={ManmeetPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                        <h1>Manmeet Kaur</h1>
                    ...
                    <div class="item">
                        <img src={VarshaPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                    ...
                    <div class="item">
                        <img src={JeaminPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                        <h1>Jeamin Shin</h1>
                    ...
                    <div class="item">
                        <img src={GlennPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                        <h1>Glenn Chen</h1>
                    ...
                    <div class="item">
                        <img src={ArnavPhoto} class="topImage"></img>
                        <h2>SHOUTOUT TO</h2>
                        <h1>Arnav Rastogi</h1>
